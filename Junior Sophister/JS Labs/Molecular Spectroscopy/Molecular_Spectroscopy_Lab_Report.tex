...
\section{Abstract}
The experiment described in this report regarded the use of two moderate resolution spectrometers to analyse the emission spectrum of $N_2$. The spectrometers were calibrated using a mercury lamp, and the emission spectrum of $N_2$ was captured afterward. The wavenumbers of the peaks were calculated, and used to calculate the dissociation energy of the molecule, as well as the values of $\tilde{\nu}_B$, $\tilde{\nu}_Bx_B$, $\tilde{\nu}_C$, and $\tilde{\nu}_Cx_C$, parameters of the vibronic transition emissions.\\
\indent While initially, there were further parts for which data was collected, involving the $I_2$ absorption spectrum, the data was not used in the final analysis due to time constraints, and so is not included in this report.\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{/home/dj-lawton/Documents/Junior Sophister/JS Labs/Molecular Spectroscopy/Images/ResolutionvsWavelength.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{/home/dj-lawton/Documents/Junior Sophister/JS Labs/Molecular Spectroscopy/Images/N2_T_Spectrum_fitted.pdf}
...
\vspace{0.5cm}\\
\begin{tabular}{p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|p{0.05\textwidth}|}
    \hline
    \hline
    $\nu^{\prime}/\nu^{''}$ & 0 & $\Delta\tilde{\nu}_1$ & 1 & $\Delta\tilde{\nu}_2$ & 2 & $\Delta\tilde{\nu}_3$ & 3 & $\Delta\tilde{\nu}_4$ & 4 & $\Delta\tilde{\nu}_5$ & 5 & $\Delta\tilde{\nu}_6$ & 6\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{/home/dj-lawton/Documents/Junior Sophister/JS Labs/Molecular Spectroscopy/Images/TransitionWavenumbersDiffs.pdf}
